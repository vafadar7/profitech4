...
import { loadAdminProducts } from './AdminPanel';
...
export default function ProductsSection({
  ...
  const [adminProducts, setAdminProducts] = useState<Product[]>(loadAdminProducts);

  // Sync admin products when admin panel updates them
  useEffect(() => {
    const handler = () => setAdminProducts(loadAdminProducts());
