...
export default function FilterSidebar({
  ...
  return (
    <>
      {/* ─── DESKTOP: sticky sidebar, full internal scroll ─── */}
      <aside className="hidden lg:block w-60 xl:w-64 flex-shrink-0">
        <div
          className="sticky top-16 bg-card rounded-2xl border border-border overflow-y-auto"
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="lg:hidden fixed top-0 left-0 bottom-0 z-50 w-72 bg-card shadow-2xl"
            >
              {sidebarContent(true)}
            </motion.div>
          </>
