        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <div className="flex items-center h-14 sm:h-16 gap-2 sm:gap-3">
            ...
            <a href="#hero" className="hidden sm:flex items-center gap-2 flex-shrink-0 mr-1">
              <div className="w-8 h-8 rounded-lg bg-secondary flex items-center justify-center font-bold text-white text-sm">P</div>
              <span className="font-heading font-bold text-white text-base whitespace-nowrap">ProfiTech</span>
            </a>
            ...
            >
              <div className="flex items-center justify-between px-5 py-4 border-b border-white/10">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-secondary flex items-center justify-center font-bold text-white text-sm">P</div>
                  <span className="font-heading font-bold text-white">ProfiTech</span>
                </div>
